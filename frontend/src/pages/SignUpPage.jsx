...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-white'>
			...
			>
				<div className='bg-white py-8 px-6 shadow-md border border-gray-200 sm:rounded-lg sm:px-10'>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-white border border-gray-300 text-gray-800 
