...
const GiftCouponCard = () => {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-md sm:p-6'
		...
		>
            ...
            p-2.5 text-sm text-gray-800 placeholder-gray-400 focus:border-emerald-500 
